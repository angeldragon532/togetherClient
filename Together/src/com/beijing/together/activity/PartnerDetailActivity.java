...
public class PartnerDetailActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.partner_detail_info);
		initView();
	...
	private void initView(){
		...
		contactLayout = (LinearLayout)findViewById(R.id.user_info_contact_id);
	...
	private void initData(){
		titleCollection.setImageResource(R.drawable.collection);
